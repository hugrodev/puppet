...
const CATG_NB: Category = {
    ...
    oeil_gauche: { nom: "oeil_gauche", skin: false, nbImg: 7, color: false },
    ...
    oeil_droit: { nom: "oeil_droit", skin: false, nbImg: 7, color: false },
    visage: { nom: "visage", skin: true, nbImg: 8, color: false },
    corps: { nom: "corps", skin: true, nbImg: 2, color: true },
  };
